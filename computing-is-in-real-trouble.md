...
#### Alan Kay, [iPad is only good for 2-year and 82-year olds](https://www.youtube.com/watch?v=ubaX1Smg6pY&t=85m33s)
User interface on the iPad is so bad because they went to the lowest common denominator. I have a nice slide which shows 2-year old kid using and iPad and 85-year old lady using an iPad, and the next thing shows both of them in walkers, because that is what Apple has catered to. But in between people use tools. You can buy a capacitor pen, but where to you put it? So Apple, in spite of the fact of making pretty good touch-sensitive surface, absolutely has no thought of selling to anybody who wants to learn something. Again, who cares? There is nothing wrong with something that is braindead and only shows ordinary media. The problem is that people do not know that it is braindead, and so it is actually replacing computers that can actually do more for childern, and to me that is anti-ethical.
...
#### Alan Kay, [Nothing could be stupider than programmers trying to make Intel CPUs look good](https://www.youtube.com/watch?v=ubaX1Smg6pY&t=9m3s)
